...
class kütüphane():
    ...
    def baglanti_olustur(self):
        self.baglanti = sqlite3.connect("kütüphaneler.db")
        self.cursor = self.baglanti.cursor()
        sorgu = "Create Table ıf not exists kitaplar(isim TEXT,yazar TEXT,yayınevi Text,tür TEXT,baskı INT)"
    ...
    def kitap_sorgula(self,isim):
        sorgu = "Select * FROM kitaplar where = ?"
